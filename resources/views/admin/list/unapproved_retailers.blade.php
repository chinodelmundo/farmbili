...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-10">
            <h3 class="page-header"> <span class="glyphicon glyphicon-user"></span> Unapproved Retailers </h3>
            <div class="panel panel-default">
                <div class="panel-body">
                    @if($users->count() > 0)
                        <table class="table table-striped table-hover table-bordered table-condensed" id="unapproved-table" data-order='[[ 1, "asc" ]]'>
                            <thead>    
                                <tr>
                                    <th></th>
                                    <th>Name</th>
                                                    ...
                                                    <div class="modal-dialog">     
                                                        <div class="modal-content">
                                                            <div class="modal-body">
                                                                <div class="row">
                                                                    <div class="col-md-12">
                                                                        <img class="img-rounded" src="/images/uploads/{{$user->images()->where('is_primary', 1)->first()->file_name}}" width="100%" height="100%">
                                                                    </div>
                                                                </div>
                                                                <div class="row">
                                                                    <div class="col-md-3">
